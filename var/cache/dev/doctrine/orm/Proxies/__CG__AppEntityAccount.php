...
class Account extends \App\Entity\Account implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Account' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Account' . "\0" . 'name', '' . "\0" . 'App\\Entity\\Account' . "\0" . 'balance', '' . "\0" . 'App\\Entity\\Account' . "\0" . 'departureTransactions', '' . "\0" . 'App\\Entity\\Account' . "\0" . 'arrivalTransactions', '' . "\0" . 'App\\Entity\\Account' . "\0" . 'beneficiaire'];
        }
    ...
    public function subToBalance(int $amount): ?int
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'subToBalance', [$amount]);

        return parent::subToBalance($amount);
    }
     ...
     * {@inheritDoc}
     */
    public function addBeneficiaire(\App\Entity\Account $beneficiaire): \App\Entity\Account
    {
     ...
     * {@inheritDoc}
     */
    public function removeBeneficiaire(\App\Entity\Account $beneficiaire): \App\Entity\Account
    {
