...
class __TwigTemplate_205c3ccff8dcf4511822ae03ff7b05765e924638b8efa8f2250db316be3ede11 extends Twig_Template
{
    ...
    <form action=\"";
        ...
        <div class=\"form-group\">
            <input placeholder=\" Adresse email ...\" required=\"required\" name=\"_username\" type=\"text\" class=\"form-control\">
        </div>
        <div class=\"form-group\">
            <input placeholder=\" Mot de passse\" required=\"required\" name=\"_password\" type=\"password\" class=\"form-control\">
        </div>
        <div class=\"form-group\">
...
{% endblock %}", "security/login.html.twig", "/Users/raphaelgoncalves/Documents/GitHub/Site_Appiculture_Lpdw/templates/security/login.html.twig");
    }
}
