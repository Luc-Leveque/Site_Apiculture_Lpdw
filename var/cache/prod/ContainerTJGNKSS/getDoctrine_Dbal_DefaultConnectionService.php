...
include_once $this->targetDirs[3].'/src/EventListener/TransactionListener.php';
...
$a->addEventListener(array(0 => 'postPersist'), new \App\EventListener\TransactionListener());
