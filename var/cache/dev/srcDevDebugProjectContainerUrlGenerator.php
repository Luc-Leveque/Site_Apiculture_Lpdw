...
class srcDevDebugProjectContainerUrlGenerator extends Symfony\Component\Routing\Generator\UrlGenerator
{
    ...
    public function __construct(RequestContext $context, LoggerInterface $logger = null, string $defaultLocale = null)
    {
        ...
        'blog_edit' => array(array('id'), array('_controller' => 'App\\Controller\\BlogController::form'), array(), array(array('text', '/edit'), array('variable', '/', '[^/]++', 'id'), array('text', '/blog')), array(), array()),
        'blog_show' => array(array('id'), array('_controller' => 'App\\Controller\\BlogController::show'), array(), array(array('variable', '/', '[^/]++', 'id'), array('text', '/blog')), array(), array()),
