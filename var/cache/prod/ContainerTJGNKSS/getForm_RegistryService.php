...
return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Form\\AccountCreateType' => function () {
    return ($this->privates['App\Form\AccountCreateType'] ?? $this->privates['App\Form\AccountCreateType'] = new \App\Form\AccountCreateType());
}, 'App\\Form\\BeneficiaireCreateType' => function () {
    return ($this->privates['App\Form\BeneficiaireCreateType'] ?? $this->privates['App\Form\BeneficiaireCreateType'] = new \App\Form\BeneficiaireCreateType());
}, 'App\\Form\\TransactionCreateType' => function () {
    return ($this->privates['App\Form\TransactionCreateType'] ?? $this->privates['App\Form\TransactionCreateType'] = new \App\Form\TransactionCreateType());
